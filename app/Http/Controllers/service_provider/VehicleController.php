...
class VehicleController extends Controller
{
    ...
    {
        $vehicles = Vehicle::where('service_provider_id', Auth()->user()->id)->orderBy('id', 'DESC')->paginate(25);

        return view('service_provider.vehicles.index', compact('vehicles'));
    }
    ...
    {
        return view('service_provider.vehicles.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('s_p_vehicles.index')->with($notification);
    }
    ...
    public function edit($id)
    {
        ...
        return view('service_provider.vehicles.edit', compact('Vehicle'));
    }
