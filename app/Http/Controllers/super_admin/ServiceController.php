...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super_admin.website.service.index', compact('services'));
    }
    ...
    {
        return view('super_admin.website.service.add');
    }
    ...
    {
        return view('super_admin.website.service.edit', compact('service'));
    }
