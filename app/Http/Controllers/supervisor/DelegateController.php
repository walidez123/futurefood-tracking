...
class DelegateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $delegates = User::where('user_type', 'delegate')->whereIn('id', $Arraydelegates)->where('work', $request->type)->orderBy('id', 'desc')->get();

        return view('supervisor.delegates.index', compact('delegates', 'type'));
    }
    ...
    public function tracking()
    {
        ...
        return view('supervisor.delegates.tracking', compact('delegates'));
    }
    ...
    public function orders($id)
    {
        ...
        return view('supervisor.delegates.orders', compact('orders'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('supervisor.delegates.add', compact('cities', 'type', 'clients', 'supervisors', 'service_providers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor-delegates.index', ['type' => $delegate->work])->with($notification);
    }
    ...
    public function show($id)
    {
        ...
        // $this->authorize('showDelegateSupervisor', $delegate);
        ...
        return view('supervisor.delegates.show', compact('delegate', 'statuses', 'supervisors'));
    }
    ...
    public function edit(User $delegate)
    {
        ...
        return view('supervisor.delegates.edit', compact('delegate', 'cities', 'region', 'clients', 'Delegate_client', 'service_providers', 'supervisors'));
    }
    ...
    public function balances(Request $request)
    {
        ...
        return view('supervisor.delegates.balances', compact('delegates'));
    }
    ...
    public function transactions(Request $request, $id)
    {
        ...
        if ($delegate) {
            ...
            return view('supervisor.delegates.balance-transactions', compact('alltransactions', 'transactions', 'delegate', 'from', 'to', 'count_debtor', 'count_creditor', 'count_order_creditor', 'count_order_debtor'));
        } else {
            abort(404);
        }
    }
