...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'details' => 'التفاصيل',
        'work_type' => 'نوع الطلب',
        'max' => 'الحد الأعلى للطلبات',
        'delegate_id' => 'اختر مندوب',
        'link' => ' ',
        'slug' => ' ',
        'license_photo' => 'صورة الرخصة',
        'avatar' => 'الصورة الشخصية',
        'residence_photo' => 'صورة الإقامة',
        ...
        'receved_phone' => 'رقم المرسل إليه',
        'amount_paid' => 'حالة الدفع',
        'receved_address' => 'عنوان المرسل إلية',
        'product_name' => 'أسم المنتج',
        'manger_phone' => 'رقم الشخص المسؤول',
        'is_transport' => 'هل مشترك فى هئية النقل العام',
        'city_id' => 'المدينة',
        'num_employees' => 'عدد الموظفين',
        'num_cars' => 'عدد السيارات',
        'nationality' => 'الجنسية',
        'region_id' => 'الحى',
        'type_vehicle' => 'نوع المركبة',
        'Num_vehicle' => 'رقم اللوحة المركبة',
        ...
        'total' => 'الإجمالى',
        'SKUS' => 'SKUS',
        'warehouse_id' => 'فرع المستودع',
        'store_address_id' => 'العنوان',
        'storage_types' => 'نوعية التخزين',
        'phone'=>"رقم الهاتف"
