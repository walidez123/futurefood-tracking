    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                @endif
                <form id="formRuls" action="{{ route('AssignOrdersRule.update', $Orders_rules->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <fieldset class="box-body overflow-auto border rounded p-3 bg-white"
                        ...
                        <div class="col-md-12" style="padding-left: 0px;padding-right: 0px;padding-top: 5px">
                            ...
                            <div class="col-md-2">
                                ...
                                <select id="client_id" class="form-control select2 client_assign" name="client_id">
                                    <option value="">
                                ...
                                <tbody>
                                    @foreach ($Orders_rules->order_rules_details as $details)
                                        <tr>
                                            ...
                                            <td>{{ $details->address_id ? $details->address->address : '-' }}</td>
                                            ...
                                            <td>
                                                <form id="deleteForm{{$details->id}}" action="{{ route('delete_orders_rule_details', $details->id) }}" method="post" style="display: none;">
                                                </form>
                                                <form id="deleteForm{{$details->id}}" class="pull-right" style="display: inline;" action="{{route('delete_orders_rule_details', $details->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
