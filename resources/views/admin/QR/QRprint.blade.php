...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('layouts._header-form', [
            'title' => __('admin_message.Print'),
            'type' => __('admin_message.Print'),
            'iconClass' => 'fa-print',
        ...
        <section class="invoice">
            ...
            <div class="row invoice-info">
                ...
                @foreach ($all_good as $good)
                    @for ($i = 1; $i <= $number; $i++)
                        <div class="col-xs-2 col-md-2 col-lg-2  invoice-col">
                            <div class="col-xs-12 col-md-12 col-lg-12 text-center"> <!-- Add text-center class here -->
                                @if ($type == 'QRcode')
                                    {!! QrCode::size(40)->generate($good[0]) !!}
                                    <h6>{{ $good[0] }}</h6> 
                                @elseif($type == 'Barcode')
                        ...
                        @for ($i = 1; $i <= $number; $i++)
                            ...
                            <div class="col-xs-3 col-md-3 col-lg-3  invoice-col">
                                <div class="col-xs-12 col-md-12 col-lg-12 ">
                                    ...
                                    @if ($type == 'QRcode')
                                        {!! QrCode::size(150)->generate(utf8_encode($warahouse1[0])) !!}
