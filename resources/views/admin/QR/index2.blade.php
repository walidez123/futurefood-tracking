...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <form action="{{route('QR.store2')}}" method="POST">
                @csrf
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="box box-primary" style="padding: 10px;">
                        ...
                        <div class="box-body">
                            <div class=" form-group">
                                <label for="goods" class="control-label">  رقم البداية  </label>
                                <input type="number" required class="form-control"  name="start_number">
                            </div>
