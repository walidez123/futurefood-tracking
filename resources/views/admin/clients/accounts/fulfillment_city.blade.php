<div class="col-xs-12 col-lg-6 form-group">
                        ...
                        <div class="col-xs-12 col-lg-6 form-group">
                                            <label for="" class="control-label"> {{__('admin_message.Delivery cost outside')}} {{__('admin_message.City')}}</label>
        
                                            <div class="">
                                                <input value="{{ old('cost_outside_city') }}" type="number" step="any" min="0" class="form-control" name="cost_outside_city"
                                                    placeholder="{{__('admin_message.Delivery cost outside')}} {{__('admin_message.City')}}" >
                                ...
                                <div class="col-xs-12 col-lg-6 form-group">
                                 ...
                                 <div class="col-xs-12 col-lg-6 form-group">
                                   ...
                                   <div class="col-xs-12 col-lg-6 form-group">
                                        ...
                                        <div class="col-xs-12 col-lg-6 form-group">
                                            <label for="" class="control-label">{{__('admin_message.standard weight outside')}} {{__('admin_message.City')}}   </label>
                                            <div class="">
                                                <input value="{{ old('standard_weight_outside') }}" type="number" step="any" min="0" class="form-control" name="standard_weight_outside"
                                                    placeholder="{{__('admin_message.standard weight outside')}} {{__('admin_message.City')}}" >
