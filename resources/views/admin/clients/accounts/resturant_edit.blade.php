<div class="col-xs-12 col-lg-6 form-group">
    <label for="" class="control-label">{{__("admin_message.Delivery cost inside city")}}</label>
    <div class="">
        <input value="{{$client->cost_inside_city}}" type="number" step="any" min="0" class="form-control" name="cost_inside_city"
            placeholder="{{__('admin_message.Delivery cost inside city')}}" required>
...
<div class="col-xs-12 col-lg-6 form-group">
    ...
    <div class="">
        <input value="{{$client->additional_kilo_price}}" type="number" step="any" min="0"
...
<div class="col-xs-12 col-lg-6 form-group">
    ...
    <div class="">
        <input value="{{$client->kilos_number}}" step="any" min="0"
...
<div class="col-xs-12 col-lg-6 form-group">
    ...
    <div class="">
        <input value="{{$client->fees_cash_on_delivery}}" type="number" step="any" min="0" name="fees_cash_on_delivery"
            class="form-control" placeholder="{{__('admin_message.fees cost on delivery')}}" required>
...
<div class="col-xs-12 col-lg-6 form-group">
    ...
    <div class="">
        <input value="{{$client->cost_reshipping}}" type="number"  step="any" min="0" name="cost_reshipping" class="form-control"
