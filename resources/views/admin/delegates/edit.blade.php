                    ...
                    <div class="tab-content" style="padding-top: 10px;">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label for="lastname" class="control-label">{{__('admin_message.Work Type')}} *</label>
                                    <div class="">
                                    <select multiple id="Delegate_work_type" class="form-control select2" name="works[]" required>
                                            <option value="">{{__('admin_message.Select')}} {{__('admin_message.Work Type')}}</option>
                                            @if (in_array(1, $user_type))

<option {{(in_array(1,$works)) ? 'selected' : ''}} value="1">{{__('admin_message.Clients')}}</option>
@endif
@if (in_array(2, $user_type))

<option {{(in_array(2,$works)) ? 'selected' : ''}} value="2">{{__('admin_message.restaurants')}}</option>
@endif
@if (in_array(4, $user_type) )
<option {{(in_array(4,$works)) ? 'selected' : ''}} value="4">{{__('fulfillment.fulfillment')}}</option>
@endif
                        ...
                        <div class="tab-pane" id="JobData">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <select multiple id="delegate_clients" class="form-control select2" name="client[]">
                                            <option value="">{{__('admin_message.Select')}}
