                ...
                <div class="col-lg-12">
                    <div class="box box-solid">
                        ...
                        <div class="col-xs-12 col-md-3">
                            ...
                            <p> @if($delegate->is_active==1)
                                <a href="{{route('delegates.activation', $delegate->id)}}" title="View"
                                    class="btn btn-sm btn-danger" style="margin: 2px;"><span
                                        class="hidden-xs hidden-sm">{{__('admin_message.inactivation')}}</span> </a>

                                @else
                                <a href="{{route('delegates.activation', $delegate->id)}}" title="View"
                                    class="btn btn-sm btn-success" style="margin: 2px;"> <span
                                        class="hidden-xs hidden-sm">{{__('admin_message.Activation')}}</span> </a>
                        ...
                        <div class="col-xs-12 col-md-3">
                            ...
                            <p> {{ is_null($delegate->neighborhood) ? '' : $delegate->neighborhood->trans('title') }}
                            </p>
                        </div>
                        <div class="col-xs-12 col-md-3">
