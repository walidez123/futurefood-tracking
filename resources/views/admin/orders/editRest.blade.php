...
<div class="form-group">
                            <label>{{__("app.Payment Method")}} </label>
                            <select class="form-control select2" id="payment_method" name="payment_method" required>
                                <option {{ $order->payment_method == 1 ? 'selected' : '' }} value="1">{{__("app.cash")}}</option>
                                <option {{ $order->payment_method == 2 ? 'selected' : '' }} value="2"> {{__("app.network")}}</option>
                                <option {{ $order->payment_method == 3 ? 'selected' : '' }} value="3"> {{__("app.online")}}</option>
                ...
                <div style="margin-right: auto;" class="form-group row">
                          ...
                          {{__("admin_message.product_name")}}                           </div>
                           ...
                           <div class="col-lg-2 ">
                            <a class="btn btn-sm btn-danger" href="{{route('orderclient.delete_product', $product->id)}}"> <i class="fa fa-trash" aria-hidden="true"></i> {{__("admin_message.Delete")}}</a>
                           </div>
                           <br>
