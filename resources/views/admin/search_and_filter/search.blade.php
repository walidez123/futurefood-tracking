                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="filter1">
                                <div class="row ">
                                    <form action="{{ route('filter-and-search.store') }}" method="post" class="col-xs-12">
                                        @csrf
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control select2" name="paid">
                                                ...
                                                <option {{ isset($paid) && $paid == 1 ? 'selected' : '' }} value="1">
                                                    {{ __('admin_message.Paid') }}</option>
                                                <option {{ isset($paid) && $paid == 0 ? 'selected' : '' }} value="0">
                                                    {{ __('admin_message.UnPaid') }}</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-6">
