                    ...
                    <div class="box box-primary" style="padding: 10px;">
                        ...
                        <div class="box-body">
                            ...
                            @if($status->otp_send_code == 1 )
                                <div class="form-group col-md-6 otp_status_send">
                                    ...
                                    <select   name="otp_status_send" class="form-control">
                                        ...
                                        <option value="all" {{$status->otp_status_send == 'all' ? 'selected' : ''}}>{{__('admin_message.all')}}</option>
                                        <option value="cc" {{$status->otp_status_send == 'cc' ? 'selected' : ''}}>{{__('admin_message.Paid')}}</option>
                                        <option value="cod" {{$status->otp_status_send == 'cod' ? 'selected' : ''}}>{{__('admin_message.UnPaid')}}</option>
                                    </select>
                                </div>
                            @else
                            ...
                            <div class="form-group col-md-6">
                            <label for="fulfillment_appear">{{__('admin_message.appear')}} {{__('fulfillment.fulfillment')}}</label>
                                <select name="fulfillment_appear" class="form-control">
                                    <option value="1" {{$status->fulfillment_appear == 1 ? 'selected' : ''}}>{{__('admin_message.Yes')}}</option>
                                    <option value="0" {{$status->fulfillment_appear == 0 ? 'selected' : ''}}>{{__('admin_message.No')}}</option>
                                </select>
                            </div>
                            @endif
