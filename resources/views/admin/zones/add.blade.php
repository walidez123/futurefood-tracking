...
@section('pageTitle',__("admin_message.Tier").' '.__("admin_message.Add"))
@section('css')
...
<div class="content-wrapper">
    ...
    @include('layouts._header-form', ['title' => __("admin_message.Tier"), 'type' =>__("admin_message.Add"), 'iconClass' => 'fa-map-marker', 'url' => route('CityZone.index'), 'multiLang' => 'false'])

    <!-- Main content -->
    <section class="content">
        <div class="row">

            <form action="{{route('CityZone.store')}}" method="POST">
                @csrf
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="box box-primary" style="padding: 10px;">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{__("admin_message.Add")}} {{__("admin_message.Tier")}} </h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select required  multiple class="form-control select2" name="city[]" >
                                    <option value="">{{__('admin_message.Select')}} {{__('admin_message.City')}}</option>
                                    @foreach($cities as $city)
                                    @if(in_array($city->id,$city_Zone))
                                    @else
