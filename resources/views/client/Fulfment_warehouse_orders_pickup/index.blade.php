              ...
              <div class="nav-tabs-custom" style="padding:12px">
                  <div class="row">
                      ...
                      <div class="col-lg-3 col-xs-12">
                           <a class="btn btn-success pull-right"  href="{{route('orders_pickup.create')}}">@lang('order.add_new_order') </a>
                      </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('orders_pickup.show', $order->id)}}" title="View" class="btn btn-sm btn-warning"
