...
<div class="content-wrapper">
    ...
    @include('layouts._header-form', ['title' => __('app.address'), 'type' => __('app.add'), 'iconClass' =>
    'fa-map-marker', 'url' =>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="box box-primary" style="padding: 10px;">
                        ...
                        <div class="box-body">
                            ...
                            <!--</div>-->
                            <div class="form-group">
                                <label for="email" class="control-label">@lang('app.detials', ['attribute' => ''])
                                </label>

                                <div class="">
                                    <textarea name="description" class="form-control"
                                        id="inputEmail">{{ old('description') }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
