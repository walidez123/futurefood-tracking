                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <select id="city_id" class="form-control select2" name="city_id" >
                                            ...
                                            <option {{($address->city_id == $city->id) ? 'selected' : ''}} value="{{$city->id}}">{{$city->trans('title')}}</option>
                                            @endforeach
                                    ...
                                    <div class="">
                                        <select id="neighborhood_id" class="form-control select2" name="neighborhood_id" >
                                            @if($region!=null)
                                            <option value="{{$region->id}}">{{$region->trans('title')}}</option>
                                            @endif
                                ...
                                <div class="">
                                    <select id="" class="form-control select2" name="main_address" >
                                        <option {{($address->main_address == 0) ? 'selected' : ''}} value="0">{{__('admin_message.No')}}</option>
                                        <option {{($address->main_address == 1) ? 'selected' : ''}} value="1">{{__('admin_message.Yes')}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    placeholder="Details" >{{ $address->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('js')
    ...
    {{-- <script type="text/javascript" src="{{asset('assets/bower_components/admin/show_map2.js')}}"></script>  --}}
