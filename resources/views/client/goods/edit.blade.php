...
<div class="content-wrapper">
        ...
        @include('layouts._header-form', ['title' =>trans('goods.Goods'), 'type' =>trans('goods.edit'), 'iconClass' => 'fa-map-marker', 'url' => route('client-goods.index'), 'multiLang' => 'false'])
    
        <!-- Main content -->
        <section class="content">
            <div class="row">
    
                <form action="{{route('client-goods.update', $Good->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12 ">
                        ...
                        <div class="box box-primary" style="padding: 10px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" {{$Good->has_expire_date == 1 ? 'checked' : ''}} name="has_expire_date"  type="checkbox"
                                        id="expire_checkbox">
