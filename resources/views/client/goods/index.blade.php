...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <!-- @include('layouts._header-index', [
            ...
            'addUrl' => route('client-goods.create'),
            'multiLang' => 'false',
        ]) -->
            ...
            <div class="active tab-pane" id="filter1">
                <div class="row ">
                    <div class="col-lg-2 col-xs-12">
                        <a type="button" href="{{ route('client-goods.create') }}"
                            class="btn btn-success">{{ trans('goods.Goods') }} <i class="fa-solid fa-plus"></i>
                        </a>
                    </div>
                    <div class="col-lg-2 col-xs-12">
                    ...
                    <div class="col-lg-2 col-xs-12">
                        <a type="button" href="{{ route('client-good.download_execl') }}"
        ...
        <div class="modal fade" id="exampleModalExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('client-goods.import_execl') }}" method="POST" enctype='multipart/form-data'>
                                        ...
                                        <tr>
                                            ...
                                            @if ($good->image == 'avatar/avatar.png' || $good->image == null)
                                                <td><img class="img-circle"
                                                        src="{{ asset('storage/' . $webSetting->logo) }}" height="75"
                                                        width="75"></td>
                                            @else
                                                <td><img class="img-circle" src="{{ asset('storage/' . $good->image) }}"
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('client-goods.edit', $good->id) }}" title="Edit"
                                                    class="btn btn-sm btn-primary" style="margin: 2px;"><i
                                                        class="fa fa-edit"></i> <span
                                                        class="hidden-xs hidden-sm">@lang('goods.edit')</span></a>

<a href="{{route('client-goods.show', $good->id)}}" title="View"
    class="btn btn-sm btn-warning" style="margin: 2px;"><i class="fa fa-eye"></i>
    <span class="hidden-xs hidden-sm">@lang('goods.show')</span></a>

                                    <a href="{{route('client-goods.details', $good->id)}}" title="Edit"
                                        ...
                                        <span class="hidden-xs hidden-sm">@lang('goods.print')</span></a>
                                                ...
                                                <a href="{{ route('client-goods.Qrcode', $good->id) }}" title="Edit"
                                                    class="btn btn-sm btn-primary" style="margin: 2px;"><i
                                                        class="fa fa-qrcode"></i> <span
                                                        class="hidden-xs hidden-sm">@lang('goods.generate_qr_code') (QRcode)</span></a>

                                                <a href="{{ route('client-goods.Barcode', $good->id) }}" title="Edit"
                                                    class="btn btn-sm btn-primary" style="margin: 2px;"><i
                                                        class="fa fa-qrcode"></i> <span
                                                        class="hidden-xs hidden-sm">@lang('goods.generate_qr_code') (Barcode)</span></a>


                                                <form class="pull-right" style="display: inline;"
                                                    action="{{ route('client-goods.destroy', $good->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
