...
<div class="content-wrapper">
  ...
  <section class="invoice">
    ...
    {{-- show order products --}}
    @if($order->Order->product && count($order->Order->product) > 0)
        <div class="row">
            ...
            <table class="table table-bordered table-striped table-hover ">
                ...
                <tbody>
                    ...
                    @foreach ($order->Order->product as $i=>$product)
                    <tr>
        ...
        @if($order->Order->goods && count($order->Order->goods) > 0)
        <div class="row">
            <h3>{{__("app.order products")}}</h3>
            ...
            ?>
                    @foreach ($order->Order->goods as $i=>$product)
                    <tr>
