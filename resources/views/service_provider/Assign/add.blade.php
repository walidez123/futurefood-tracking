...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        {{-- @include('layouts._header-form', [
            ...
            'url' => route('order_rule_provider.index'),
            'multiLang' => 'false',
        ]) --}}
        <!-- Main content -->
        <section class="content">
            <div class="row">
                ...
                @endif
                <form id="formRuls" action="{{ route('order_rule_provider.store') }}" method="post">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="work_type" class="form-control" id="work_type" required>
                                            ...
                                            <option value="client">{{ __('admin_message.Client') }}</option>
                                            <option value="restaurant">{{ __('admin_message.restaurant') }}</option>
                                            <option value="branch">{{ __('admin_message.branch') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <fieldset class="box-body overflow-auto border rounded p-3 bg-white"
                        ...
                        <div id="parentTable" style="display: none !important;margin-top:80px">
