    ...
    <section class="content">
        <div class="row">
            ...
            <div class="nav-tabs-custom">
                ...
                <form action="{{route('s_p_delegates.store')}}" method="POST" class="box  col-md-12"
                        ...
                        <div class="tab-pane active" id="Main">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" value="{{$code}}" name="code" class="form-control"
                        ...
                        <div class="tab-pane" id="Registration">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input value="{{ old('phone') }}" required type="text" name="phone" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <select name="service_provider" id="service_provider"
                                            ...
                                            <option selected value="{{$service_providers->id}}">{{$service_providers->name}}
                                            </option>
