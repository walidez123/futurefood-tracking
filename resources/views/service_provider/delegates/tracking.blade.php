...
<div class="content-wrapper">
  ...
  @include('layouts._header-index', ['title' => 'Tracking', 'iconClass' => 'fa-map-marker', 'addUrl' => '', 'multiLang' => 'false'])
    @include('layouts._header-index', ['title' => 'توزيع المناديب على الخريطة', 'iconClass' => 'fa-map-marker', 'addUrl' => url('admin/delegates/tracking-map'), 'multiLang' => 'false'])
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <!--    class="fa fa-map-marker"></i> <span class="hidden-xs hidden-sm">Tracking</span></a>-->
                        <a href="{{url('admin/tracking-map/'.$delegate->id.'')}}" title="Edit" class="btn btn-sm btn-primary" style="margin: 2px;"><i
                        class="fa fa-map-marker"></i> <span class="hidden-xs hidden-sm">Tracking</span></a>
                    @endif
