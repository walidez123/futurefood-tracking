        ...
        <div class="row">
            ...
            <div class="col-xs-6 printhidden" style="float:left">
                ...
                @if($order->status_id == 4 && !$order->is_returned)
                    <a class="btn btn-primary" href="{{ route('service_provider_orders.return',['order' => $order]) }}" target="_blank"> انشاء مرتجع طلب</a>
                @endif
            </div>
  ...
  @if($order->real_image_confirm!=NULL)
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <a class="btn btn-info pull-right printhidden" href="{{route('service_provider_orders.index',['work_type'=>$order->work_type])}}"><i
