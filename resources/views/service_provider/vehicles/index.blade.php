...
@include('layouts._header-index', ['title' =>__("admin_message.vehicle"), 'iconClass' => 'fa-car', 'addUrl' => route('s_p_vehicles.create'), 'multiLang' => 'false'])
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                     ...
                     <a href="{{route('s_p_vehicles.edit', $vehicle->id)}}" title="Edit" class="btn btn-sm btn-primary"
                      style="margin: 2px;"><i class="fa fa-edit"></i> <span class="hidden-xs hidden-sm">{{ __("admin_message.Edit") }}</span></a>   
                    
                      <form class="pull-right" style="display: inline;" action="{{route('s_p_vehicles.destroy', $vehicle->id)}}" method="POST">
                          @csrf
                          @method('DELETE')
