...
@endif
                <div class="nav-tabs-custom">
                    <form  enctype="multipart/form-data"  action="{{route('companies.setting.store')}}" method="POST" class="box  col-md-12"
                    ...
                    <div class="tab-content" style="padding-top: 10px;">
                        <div class="tab-pane active" id="bank">
                            ...
                            <div class="col-xs-12 form-group">
                                    ...
                                    <div class="">
                                        <input type="text" name="sms_username" class="form-control" id="sms_username"
                                ...
                                <div class="col-xs-12 form-group">
                                    ...
                                    <div class="">
                                        <input type="text" name="sms_sender_name" class="form-control" id="sms_sender_name"
                                            placeholder="  " required>
                                ...
                                @enderror
                                 ...
                                 <div class="col-xs-12 form-group">
                                    ...
                                    <div class="">
                                        <input type="text" min="0" class="form-control" name="sms_mobile"
                                            placeholder="" >
                                            @error('sms_mobile')
                                    <span class="invalid-feedback text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-xs-12 form-group">
                                    ...
                                    <div class="">
                                        <input type="password" name="sms_password" class="form-control" id="password"
