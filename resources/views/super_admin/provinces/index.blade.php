        ...
        <div class="box">
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{route('provinces.edit', $province->id)}}" title="Edit" class="btn btn-sm btn-primary"
            ...
            <form class="pull-right" style="display: inline;"
              action="{{route('provinces.destroy', $province->id)}}" method="POST">
              @csrf
              @method('DELETE')
